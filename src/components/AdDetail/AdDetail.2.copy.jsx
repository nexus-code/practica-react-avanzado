...
async function getAdDetailAsync(id) {
    const result = await getAdDetail(id).then(response => {
        return response
    })
};
...
//     const result = getAdDetailAsync(id);
...
const getAdFromAPI = (id) => {
    ...
    const result = Promise.resolve(getAdDetail(id));
    console.log('getAdFromAPI result', result);
    return result;
